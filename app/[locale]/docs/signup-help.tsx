    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="mx-auto max-w-2xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <p className="mb-6 text-gray-700 dark:text-gray-300">
          Creating an account is quick and easy. Prompt Manage offers two password-free sign-up methods:
        </p>
        ...
        <ol className="mb-6 list-decimal space-y-2 pl-6 text-gray-700 dark:text-gray-300">
          ...
          <li>
            Check your email for a 6-digit verification code (it arrives within seconds).
          </li>
        ...
        <div className="my-6 rounded-lg bg-blue-50 p-4 dark:bg-blue-900/20">
          <p className="text-sm text-blue-900 dark:text-blue-200">
            <strong>No passwords needed!</strong> Both methods provide secure, password-free authentication.
            Your account is created automatically on your first sign-in - no forms to fill out.
          </p>
        </div>
        ...
        <ul className="mb-6 list-disc space-y-2 pl-6 text-gray-700 dark:text-gray-300">
          ...
          <li>
            <strong>Code expired?</strong> Codes expire after 60 minutes. Request a new one by entering
            your email again.
          </li>
          <li>
            <strong>Using corporate/university email?</strong> Some organizations block automated emails.
            Try a personal email instead.
          </li>
