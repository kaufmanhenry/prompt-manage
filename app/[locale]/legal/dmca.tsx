      ...
      <div className="border-b">
        <div className="mx-auto max-w-4xl px-6 py-16 md:py-24">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Prompt Manage respects intellectual property rights and complies with the Digital
        ...
        <div className="space-y-16">
          ...
          <section>
            ...
            <div className="space-y-4">
              <p className="text-gray-600 dark:text-gray-400">
                For comprehensive information about the Digital Millennium Copyright Act, please
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <p>
                Prompt Manage is a platform for organizing, sharing, and managing AI prompts. This
                website qualifies as a "Service Provider" within the meaning of 17 U.S. Code § 512
                of the Digital Millennium Copyright Act ("DMCA"). As a service provider, Prompt
                Manage is entitled to certain protections from claims of copyright infringement
                under the DMCA, commonly referred to as the "safe harbor" provisions.
              </p>
              <p>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              ...
              <p>
                Prompt Manage has designated a DMCA agent and implements these procedures to
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <p>
                ...
                more of your copyrights, please immediately notify Prompt Manage's Designated
                Copyright Agent by mail or email ("Notification") providing the information
                described below, as set forth in the Digital Millennium Copyright Act of 1998
                ("DMCA").
              </p>
              <p>
                <strong className="text-red-600 dark:text-red-400">Important:</strong> Please be
                advised that you may be held liable for damages if you make material
                misrepresentations pursuant to federal law in a Notification. If you are not sure
                content located on, embedded on, or linked-to by the website infringes your
            ...
            <div className="mt-6 rounded-lg bg-gray-100 p-6 dark:bg-gray-800">
              ...
              <ol className="ml-6 list-decimal space-y-3 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  <strong>Contact information</strong> reasonably sufficient to permit the service
          ...
          <section>
            ...
            <div className="rounded-lg bg-gray-100 p-6 dark:bg-gray-800">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                <strong>Important:</strong> Only DMCA notices sent to the designated agent below
                will be processed. All other inquiries or requests will be discarded.
              </p>
              ...
              <p className="mt-4 text-sm text-gray-500 dark:text-gray-500">
                Please include "DMCA Notice" in the subject line of your email for faster
                processing.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <p>Upon receiving a valid DMCA notification, Prompt Manage will:</p>
              <ul className="ml-6 list-disc space-y-2">
              ...
              <p>
                Prompt Manage may also terminate the account of users who repeatedly infringe
                copyrights, in accordance with our Terms of Service.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <p>
                If you believe that your content was wrongly removed due to a DMCA notice, you may
                submit a counter-notification pursuant to Section 512(g)(2)&(3) of the DMCA.
              </p>
              <p>
                <strong className="text-red-600 dark:text-red-400">Important:</strong> Submitting a
                counter-notification is a serious legal action. You will be liable for any
                misrepresentations which may cause claims to be brought against Prompt Manage.
              </p>
            </div>
            ...
            <div className="mt-6 rounded-lg bg-gray-100 p-6 dark:bg-gray-800">
              ...
              <ol className="ml-6 list-decimal space-y-3 text-gray-600 dark:text-gray-400">
                <li>
                  <strong>A physical or electronic signature</strong> of the user who posted the
                  content
                </li>
                <li>
                ...
                <li>
                  <strong>A statement</strong> under penalty of perjury that the user has a good
                ...
                <li>
                  <strong>Consent to jurisdiction</strong> of the Federal District Court for the
                  judicial district in which the address is located, or if outside the United
                  States, for any judicial district in which Prompt Manage may be found
                </li>
              </ol>
            </div>

            <div className="mt-6 space-y-4 text-gray-600 dark:text-gray-400">
              <p>After receiving a valid counter-notification, Prompt Manage will:</p>
              <ul className="ml-6 list-disc space-y-2">
              ...
              <p>
                <strong>Note:</strong> If the original complainant files a court action seeking to
                restrain the user from engaging in infringing activity, the content will remain
                removed until the court resolves the matter.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <p>
                Prompt Manage maintains a policy of terminating, in appropriate circumstances, users
                who are repeat infringers. A repeat infringer is a user who has been the subject of
                more than one valid DMCA notice.
              </p>
              <p>
                We may also terminate accounts of users who submit false DMCA notices or
                counter-notifications, as such actions constitute abuse of the DMCA process.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <p>For more information about copyright law and the DMCA, please consult:</p>
              <ul className="ml-6 list-disc space-y-2">
                <li>
                  <a
                    href="https://www.copyright.gov/dmca/"
          ...
          <section>
            ...
            <div className="rounded-lg bg-yellow-50 p-6 dark:bg-yellow-900/20">
              <p className="text-yellow-800 dark:text-yellow-200">
                <strong>Disclaimer:</strong> This DMCA policy is provided for informational purposes
                only and does not constitute legal advice. If you have questions about copyright law
                or the DMCA process, please consult with a qualified attorney. Prompt Manage
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <p>
                If you have questions about this DMCA policy or need assistance with the DMCA
              ...
              <div className="rounded-lg bg-gray-100 p-6 dark:bg-gray-800">
                ...
                <p className="mt-2">
                  <strong>Note:</strong> This email is for policy questions only. DMCA notices must
                  be sent to the designated agent address listed above.
                </p>
              </div>
            </div>
          </section>
