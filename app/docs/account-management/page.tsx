import { ArrowLeft, Download, Eye, HelpCircle, Settings, Shield, Trash2, User } from 'lucide-react'
      ...
      <div className="border-b">
        <div className="mx-auto max-w-4xl px-6 py-16 md:py-24">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Everything you need to know about managing your Prompt Manage account, including
            creating accounts, viewing profiles, editing settings, and managing your data.
          </p>
        </div>
      </div>
              ...
              <div className="space-y-6 text-gray-600 dark:text-gray-400">
                <div>
                  ...
                  <ol className="list-decimal space-y-2 pl-6">
                    ...
                    <li>
                      Or visit the sign-up page directly at{' '}
                  ...
                  <div className="space-y-4">
                    <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                      ...
                      <ol className="list-decimal space-y-1 pl-6 text-sm">
                        ...
                        <li>
                          Click <strong>"Send Verification Code"</strong>
                        </li>
                ...
                <div className="rounded-lg bg-emerald-50 p-4 dark:bg-emerald-900/20">
                  <p className="text-sm text-emerald-900 dark:text-emerald-200">
                    <strong>Note:</strong> We use secure authentication methods to protect your
                    account. Your email is verified before account creation.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="space-y-4">
                    <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                      ...
                      <ol className="list-decimal space-y-1 pl-6 text-sm">
                        ...
                        <li>
                          Select <strong>"View Profile"</strong> from the dropdown menu
                        </li>
                        <li>
                    ...
                    <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                      ...
                      <p className="text-sm">
                        Visit{' '}
                        <code className="rounded bg-gray-100 px-2 py-1 text-sm dark:bg-gray-800">
                          https://promptmanage.com/profile
                        </code>{' '}
                        while signed in
                      </p>
                    </div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                      ...
                      <ul className="space-y-1 text-sm">
                        <li>
                          • <strong>Display Name:</strong> How your name appears to others
                        </li>
                        <li>
                          • <strong>Bio:</strong> Your personal or professional description
                        </li>
                        <li>
                          • <strong>Website:</strong> Your personal or professional website
                        </li>
                        <li>
                          • <strong>Join Date:</strong> When you created your account
                        </li>
                        <li>
                          • <strong>Location:</strong> Your general location (if set)
                        </li>
                      </ul>
                    </div>
                    <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                      ...
                      <ul className="space-y-1 text-sm">
                        <li>
                          • <strong>Total Prompts:</strong> Number of prompts you've created
                        </li>
                        <li>
                          • <strong>Public Prompts:</strong> Number of prompts visible to others
                        </li>
                        <li>
                          • <strong>Private Prompts:</strong> Number of prompts only you can see
                        </li>
                        <li>
                          • <strong>Last Active:</strong> When you were last active on the platform
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                      ...
                      <ol className="list-decimal space-y-1 pl-6 text-sm">
                        ...
                        <li>
                          Click on <strong>"Profile"</strong> in the sidebar
                        </li>
                  ...
                  <div className="space-y-4">
                    <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                      ...
                      <ol className="list-decimal space-y-1 pl-6 text-sm">
                        <li>Sign in to your account</li>
                        <li>
                          Click <strong>"Explore"</strong> in the top navigation
                        </li>
                        <li>
                          Or navigate directly to{' '}
                          <code className="rounded bg-gray-100 px-2 py-1 text-sm dark:bg-gray-800">
                ...
                <div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                      ...
                      <ul className="space-y-1 text-sm">
                        <li>
                          • <strong>Trending:</strong> Most popular prompts this week
                        </li>
                        <li>
                          • <strong>Recently Added:</strong> Latest prompts from the community
                        </li>
                        <li>
                          • <strong>Editor's Choice:</strong> Curated high-quality prompts
                        </li>
                        <li>
                          • <strong>Popular Categories:</strong> Most active prompt categories
                        </li>
                      </ul>
                    </div>
                    <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                      ...
                      <ul className="space-y-1 text-sm">
                        <li>
                          • <strong>Search Bar:</strong> Search by prompt name, description, or tags
                        </li>
                        <li>
                          • <strong>Category Filter:</strong> Filter by prompt type
                        </li>
                        <li>
                          • <strong>Model Filter:</strong> Filter by AI model (GPT-4, Claude, etc.)
                        </li>
                        <li>
                          • <strong>Tag Filter:</strong> Filter by specific tags
                        </li>
                        <li>
                          • <strong>Sort Options:</strong> Sort by date, popularity, or relevance
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div className="space-y-6 text-gray-600 dark:text-gray-400">
                <div className="rounded-lg bg-red-50 p-4 dark:bg-red-900/20">
                  ...
                  <p className="text-sm text-red-800 dark:text-red-300">
                    <strong>Account deletion is permanent and irreversible.</strong> Please read
                  ...
                  <div className="space-y-4">
                    <div className="rounded-lg border border-red-200 p-4 dark:border-red-800">
                      ...
                      <ul className="space-y-1 text-sm text-red-800 dark:text-red-300">
                        <li>
                          • <strong>All your prompts</strong> and their versions
                        </li>
                        <li>
                          • <strong>Account settings</strong> and preferences
                        </li>
                        <li>
                          • <strong>Usage history</strong> and statistics
                        </li>
                        <li>
                          • <strong>Profile information</strong> and bio
                        </li>
                        <li>
                          • <strong>Public prompts</strong> will be removed from the public
                          directory
                        </li>
                        <li>
                          • <strong>Subscriptions</strong> and billing information
                        </li>
                        <li>
                          • <strong>All associated data</strong> stored on our servers
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                      ...
                      <ol className="list-decimal space-y-1 pl-6 text-sm">
                        ...
                        <li>
                          <strong>Read the warning dialog carefully</strong>
                        </li>
                        <li>Confirm you understand the consequences</li>
                        <li>
                          Click <strong>"Yes, Delete My Account"</strong>
                        </li>
                    ...
                    <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                      ...
                      <ol className="list-decimal space-y-1 pl-6 text-sm">
                        <li>
                          Email <strong>support@promptmanage.com</strong>
                        </li>
                ...
                <div className="rounded-lg bg-yellow-50 p-4 dark:bg-yellow-900/20">
                  ...
                  <ul className="space-y-1 text-sm text-yellow-800 dark:text-yellow-300">
                    <li>
                      • <strong>Always export your data</strong> before deletion
                    </li>
                    <li>
                      • <strong>Save important prompts</strong> to external files
                    </li>
                    <li>
                      • <strong>Download any public prompts</strong> you want to keep
                    </li>
                    <li>
                      • <strong>Cancel subscriptions</strong> if applicable
                    </li>
                    <li>
                      • <strong>Consider alternatives</strong> like making prompts private
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                      ...
                      <ol className="list-decimal space-y-1 pl-6 text-sm">
                        <li>
                          Go to <strong>Settings</strong> → <strong>Legal & Privacy</strong>
                        </li>
                        <li>
                          Scroll to <strong>"Your Data Rights"</strong> section
                        </li>
                        <li>
                          Click <strong>"Request Export"</strong>
                        </li>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                      ...
                      <ul className="space-y-1 text-sm">
                        ...
                        <li>
                          • <strong>Right to Erasure:</strong> Request data deletion
                        </li>
                        <li>
                    ...
                    <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                      ...
                      <ul className="space-y-1 text-sm">
                        <li>
                          • <strong>Use strong passwords</strong> (if applicable)
                        </li>
                        <li>
                          • <strong>Don't share verification codes</strong>
                        </li>
                        <li>
                          • <strong>Sign out from shared devices</strong>
                        </li>
                        <li>
                          • <strong>Report suspicious activity</strong> immediately
                        </li>
                        <li>
                          • <strong>Be careful with public prompts</strong> - they're visible to
                          everyone
                        </li>
                      </ul>
                    </div>
              ...
              <div className="space-y-6 text-gray-600 dark:text-gray-400">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        • <strong>Email:</strong> support@promptmanage.com
                      </li>
                      <li>
                        • <strong>Response Time:</strong> Within 24 hours
                      </li>
                      <li>
                        • <strong>Include:</strong> Your email address and detailed description
                      </li>
                    </ul>
                  </div>
                  <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                    ...
                    <ul className="space-y-1 text-sm">
                      ...
                      <li>
                        • <strong>For:</strong> Data deletion requests, privacy concerns, legal
                        matters
                      </li>
                    </ul>
                  </div>
