    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="mb-6 text-gray-700 dark:text-gray-300">
          You can update your display name, email, and other profile details at any time. Here&rsquo;s how:
        </p>
        ...
        <ul className="list-disc pl-6 mb-6 text-gray-700 dark:text-gray-300 space-y-2">
          ...
          <li>If you can&rsquo;t access your account, try resetting your password or <a href="mailto:support@promptmanage.com" className="text-blue-600 dark:text-blue-400 underline">contact support</a>.</li>
          <li>Some settings may be restricted for security reasons. If you need help, reach out to our team.</li>
        </ul>
        <p className="text-gray-700 dark:text-gray-300">Still need help? <a href="mailto:support@promptmanage.com" className="text-blue-600 dark:text-blue-400 underline">Contact our support team</a> and we&rsquo;ll be happy to assist you.</p>
      </div>
    </div>
  )
} 