  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-gray-700 dark:text-gray-300">If you&rsquo;re having trouble signing up, <a href="mailto:support@promptmanage.com" className="text-blue-600 dark:text-blue-400 underline">contact our support team</a> and we&rsquo;ll help you get started.</p>
      </div>
    </div>
  )
} 