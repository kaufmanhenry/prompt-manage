        ...
        <div className="space-y-16">
          ...
          <section>
            <p className="text-gray-600 dark:text-gray-400">
              Prompt Manage uses the following third-party service providers (subprocessors) to deliver our services. All subprocessors are bound by data protection agreements that meet or exceed GDPR requirements.
            </p>
            ...
            <div className="space-y-8">
              ...
              <div className="border-b pb-8">
                ...
                <div className="grid gap-4 text-sm sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">SOC 2 Type II, ISO 27001, GDPR Compliant</p>
                  </div>
                </div>
                <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="mt-2 inline-block text-sm underline hover:text-gray-600 dark:hover:text-gray-300">
                  vercel.com
                </a>
              </div>
              ...
              <div className="border-b pb-8">
                ...
                <div className="grid gap-4 text-sm sm:grid-cols-2">
                  <div>
                    <p className="mb-1 font-medium">Location</p>
                    <p className="text-gray-600 dark:text-gray-400">United States (Multi-region available)</p>
                  </div>
                  <div>
                    <p className="mb-1 font-medium">Certifications</p>
                    <p className="text-gray-600 dark:text-gray-400">SOC 2 Type II, ISO 27001, GDPR Compliant, HIPAA Ready</p>
                  </div>
                </div>
                <a href="https://supabase.com" target="_blank" rel="noopener noreferrer" className="mt-2 inline-block text-sm underline hover:text-gray-600 dark:hover:text-gray-300">
                  supabase.com
                </a>
              </div>
              ...
              <div className="border-b pb-8">
                ...
                <div className="grid gap-4 text-sm sm:grid-cols-2">
                  ...
                  <div>
                    <p className="mb-1 font-medium">Certifications</p>
                    <p className="text-gray-600 dark:text-gray-400">SOC 2 Type II, GDPR Compliant</p>
                  </div>
                </div>
                <a href="https://openai.com" target="_blank" rel="noopener noreferrer" className="mt-2 inline-block text-sm underline hover:text-gray-600 dark:hover:text-gray-300">
                  openai.com
                </a>
              </div>
              ...
              <div className="pb-8">
                ...
                <div className="grid gap-4 text-sm sm:grid-cols-2">
                  <div>
                    <p className="mb-1 font-medium">Location</p>
                    <p className="text-gray-600 dark:text-gray-400">United States (Global infrastructure)</p>
                  </div>
                  <div>
                    <p className="mb-1 font-medium">Certifications</p>
                    <p className="text-gray-600 dark:text-gray-400">SOC 2 Type II, ISO 27001, GDPR Compliant</p>
                ...
                <a href="https://cloud.google.com" target="_blank" rel="noopener noreferrer" className="mt-2 inline-block text-sm underline hover:text-gray-600 dark:hover:text-gray-300">
                  cloud.google.com
                </a>
              </div>
            </div>
          ...
          <section className="border-t pt-16">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <p>We will notify all customers via email at least 30 days before engaging a new subprocessor that will process customer data.</p>
              <p>Customers may object to the use of a new subprocessor on reasonable data protection grounds by contacting legal@promptmanage.com within 30 days of receiving notification.</p>
            </div>
          </section>
          ...
          <section className="border-t pt-16">
            ...
            <div className="mt-8 flex gap-4 text-sm">
              ...
              <Link href="/security" className="underline hover:text-gray-600 dark:hover:text-gray-300">
                Security
              </Link>
            </div>
          </section>
