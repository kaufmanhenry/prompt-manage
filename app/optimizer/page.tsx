...
import { CheckCircle, Star, Users, Zap, ArrowRight, Sparkles, Target, TrendingUp } from 'lucide-react'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Optimize your AI prompts for better results. Free tool analyzes prompts and provides specific suggestions for improvement.',
    type: 'website',
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mb-8 max-w-3xl text-lg text-gray-600 dark:text-gray-300 sm:text-xl">
              Transform your AI prompts from mediocre to exceptional. Our free tool analyzes your prompts and provides specific suggestions for improvement, helping you get better results from ChatGPT, Claude, and other AI models. <Link href="/models" className="font-semibold text-blue-600 hover:underline dark:text-blue-400">See all supported models</Link>.
            </p>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Get immediate feedback on your prompt's clarity, specificity, and structure with our advanced analysis engine. <Link href="/docs/best-practices" className="font-semibold text-blue-600 hover:underline dark:text-blue-400">Learn more about prompt engineering</Link>.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Receive actionable recommendations to improve your prompts, not generic advice. Based on <Link href="/p" className="font-semibold text-emerald-600 hover:underline dark:text-emerald-400">300+ proven templates</Link> from our community.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Get improved versions of your prompts that follow best practices for AI interaction. <Link href="/?redirect=/dashboard" className="font-semibold text-blue-600 hover:underline dark:text-blue-400">Save them to your library</Link> for future use.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 md:grid-cols-3">
            <div className="text-center">
              ...
              <div className="text-lg font-medium text-gray-900 dark:text-white">Better Results</div>
              <div className="text-sm text-gray-600 dark:text-gray-300">Average improvement in AI output quality</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-green-600 dark:text-green-400">10k+</div>
              <div className="text-lg font-medium text-gray-900 dark:text-white">Prompts Analyzed</div>
              <div className="text-sm text-gray-600 dark:text-gray-300">And counting since launch</div>
            </div>
            <div className="text-center">
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Access our curated library of proven prompts for every use case. Copy, customize, and optimize.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Save your optimized prompts, create collections, and organize them by project or team.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Test your prompts on 20+ AI models including GPT-4, Claude, and Gemini without leaving the platform.
              </p>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
            Join thousands of users who are already getting 3x better results from AI with optimized prompts.
          </p>
          <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
            <ScrollToToolButton />
            <Link href="/?redirect=/dashboard">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Yes! Our Prompt Optimizer is completely free to use. No signup required, no hidden costs, no limits on usage.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Our optimization techniques work with all major AI models including ChatGPT, Claude, Gemini, and others. The principles of good prompting are universal. <Link href="/models" className="font-semibold text-blue-600 hover:underline dark:text-blue-400">See our full list of supported models</Link>.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                We analyze your prompt for clarity, specificity, context, format instructions, and other key factors. Then we provide specific suggestions and an improved version using proven prompt engineering techniques. <Link href="/docs/best-practices" className="font-semibold text-blue-600 hover:underline dark:text-blue-400">Learn more about our methodology</Link>.
              </p>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-emerald-500 to-blue-600">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-emerald-100 mb-8 max-w-2xl mx-auto">
            Don't just optimize one prompt - build a complete library of high-performing prompts that your team can use and improve over time.
          </p>
          <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
            <Link href="/?redirect=/dashboard">
