...
export const metadata: Metadata = {
  ...
  description:
    'Browse and discover hundreds of AI prompts shared by the community. Find prompts for ChatGPT, Claude, Gemini, and more. Search by model, tags, and popularity.',
  keywords:
    'AI prompts directory, ChatGPT prompts, Claude prompts, Gemini prompts, prompt discovery, AI tools, prompt sharing',
  ...
  openGraph: {
    ...
    description:
      'Browse and discover hundreds of AI prompts shared by the community. Find prompts for ChatGPT, Claude, Gemini, and more.',
