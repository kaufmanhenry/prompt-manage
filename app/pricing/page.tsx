    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 items-stretch">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 md:p-8 flex flex-col">
            ...
            <ul className="mt-4 space-y-3 text-sm text-gray-700 dark:text-gray-300 flex-1">
              <li className="flex items-start"><Check className="w-4 h-4 text-green-500 mr-2 mt-0.5" /> 25 prompts max storage</li>
              <li className="flex items-start"><Check className="w-4 h-4 text-green-500 mr-2 mt-0.5" /> Cannot run prompts</li>
              <li className="flex items-start"><Check className="w-4 h-4 text-green-500 mr-2 mt-0.5" /> Public sharing only (no team sharing)</li>
            </ul>
            {/* CTA */}
            <div className="mt-6">
          ...
          <div className="relative rounded-2xl p-1 bg-gradient-to-br from-blue-500 to-indigo-500">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-[14px] h-full p-6 md:p-8 flex flex-col">
              ...
              <div className="mb-2">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">One-time payment • Lifetime deal</p>
                {/* Urgency */}
                <div className="mt-3 inline-flex items-center gap-2 text-xs font-medium text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-900/30 rounded-full px-3 py-1 self-start">
                  <Clock className="w-4 h-4" /> Offer ends soon — {timeLeft.days}d {timeLeft.hours}h {timeLeft.minutes}m {timeLeft.seconds}s
                </div>
              ...
              <ul className="mt-4 space-y-3 text-sm text-gray-800 dark:text-gray-200 flex-1">
                <li className="flex items-start"><Check className="w-4 h-4 text-green-500 mr-2 mt-0.5" /> Unlimited prompts for all your projects</li>
                <li className="flex items-start"><Check className="w-4 h-4 text-green-500 mr-2 mt-0.5" /> Run prompts on the latest OpenAI models (more coming soon)</li>
                <li className="flex items-start"><Check className="w-4 h-4 text-green-500 mr-2 mt-0.5" /> Private collections, sharing, and team features</li>
              </ul>
              {/* CTA */}
              <div className="mt-6">
                <Link href="/auth/signup?plan=pro">
                  <Button size="lg" className="w-full bg-blue-600 hover:bg-blue-700 text-white">Grab the Lifetime Deal</Button>
                </Link>
                <p className="mt-2 text-xs text-gray-600 dark:text-gray-400 text-center">Unlock all features • Pay once, use forever</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 text-center text-xs text-gray-500 dark:text-gray-400">
          One-time purchase. No subscription. You keep access to all Pro features shipped during this offer.
        </div>

        {/* Minimal distraction-free footer link */}
        <div className="mt-10 text-center">
          <Link href="/docs">
            <Button variant="outline" size="sm">See documentation</Button>
          </Link>
        </div>
      </div>
    </div>
