    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid items-stretch gap-6 md:grid-cols-3">
          ...
          <div className="flex flex-col rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800 md:p-8">
            ...
            <ul className="mt-4 flex-1 space-y-3 text-sm text-gray-700 dark:text-gray-300">
              <li className="flex items-start">
                <Check className="mr-2 mt-0.5 h-4 w-4 text-green-500" /> 25
                prompts max storage
              </li>
              <li className="flex items-start">
                <Check className="mr-2 mt-0.5 h-4 w-4 text-green-500" /> Cannot
                run prompts
              </li>
              <li className="flex items-start">
                <Check className="mr-2 mt-0.5 h-4 w-4 text-green-500" /> Public
                sharing only (no team sharing)
              </li>
            </ul>
            {/* CTA */}
            <div className="mt-6">
          ...
          <div className="flex flex-col rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800 md:p-8">
            ...
            <ul className="mt-4 flex-1 space-y-3 text-sm text-gray-700 dark:text-gray-300">
              ...
              <li className="flex items-start">
                <Check className="mr-2 mt-0.5 h-4 w-4 text-green-500" /> Shared
            ...
            <div className="flex h-full flex-col rounded-[14px] bg-white p-6 dark:bg-gray-800 md:p-8">
              ...
              <div className="mb-2">
                ...
                <div className="mt-3 inline-flex items-center gap-2 self-start rounded-full bg-blue-50 px-3 py-1 text-xs font-medium text-blue-700 dark:bg-blue-900/30 dark:text-blue-300">
                  <Clock className="h-4 w-4" /> Offer ends soon —{' '}
                  {timeLeft.days}d {timeLeft.hours}h {timeLeft.minutes}m{' '}
                  {timeLeft.seconds}s
                </div>
                <p className="mt-3 text-sm text-gray-600 dark:text-gray-400">
                  Unlock the full power of Prompt Manage with a one-time
                  purchase.
                </p>
              </div>
              {/* Features */}
              <ul className="mt-4 flex-1 space-y-3 text-sm text-gray-800 dark:text-gray-200">
                <li className="flex items-start">
                  <Check className="mr-2 mt-0.5 h-4 w-4 text-green-500" />{' '}
                  Unlimited prompts for all your projects
                </li>
                <li className="flex items-start">
                  <Check className="mr-2 mt-0.5 h-4 w-4 text-green-500" /> Run
                  prompts on the latest OpenAI models (more coming soon)
                </li>
                <li className="flex items-start">
                  <Check className="mr-2 mt-0.5 h-4 w-4 text-green-500" />{' '}
                  Private collections, sharing, and team features
                </li>
              </ul>
              {/* CTA */}
              <div className="mt-6">
        ...
        <div className="mt-10 text-center text-xs text-gray-500 dark:text-gray-400">
          One-time purchase. No subscription. You keep access to all Pro
          features shipped during this offer.
        </div>
