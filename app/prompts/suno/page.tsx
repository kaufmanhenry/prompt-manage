import { ArrowRight, Music, Play, TrendingUp, Users } from 'lucide-react'
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: 'https://promptmanage.com/prompts/suno',
      type: 'website',
      images: [
        {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: 'Suno',
        item: 'https://promptmanage.com/prompts/suno',
      },
    ],
  }
