    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-gray-950">
        <div className="mx-auto max-w-[90rem] overflow-x-hidden px-4 sm:px-6 lg:px-8">
          ...
          {/* Directory Discovery CTA */}
          <section className="mb-20 rounded-xl border border-blue-200 bg-gradient-to-r from-blue-50 to-cyan-50 p-8 dark:border-blue-900 dark:from-blue-950 dark:to-cyan-950">
          ...
          <div className="mx-auto mb-12 max-w-4xl border-t pb-8 pt-8 sm:pt-12">
            <div className="prose prose-sm dark:prose-invert max-w-none px-4 sm:px-0">
