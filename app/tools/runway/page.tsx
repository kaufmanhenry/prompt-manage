...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: 'https://promptmanage.com/tools/runway',
      type: 'website',
      images: [
        {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: 'Runway',
        item: 'https://promptmanage.com/tools/runway',
      },
    ],
  }
        ...
        <div className="mx-auto max-w-7xl px-4 sm:p-6">
          ...
          <div className="mb-12">
            <div className="mb-8 flex flex-col items-start gap-6 sm:flex-row">
              <div className={`${runwayData.color} flex-shrink-0 rounded-xl p-4 sm:p-6`}>
