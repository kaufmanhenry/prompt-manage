      ...
      <div className="mx-auto px-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 md:gap-0">
        <div className="flex md:flex-row flex-col md:gap-8 gap-4 w-full">
          ...
          <ul className="text-sm items-center space-y-2">
            <li className="font-medium text-xs text-muted-foreground">Company</li>
            <li>
              <Link href="/" className="hover:underline text-gray-600 dark:text-gray-300">
                Home
              </Link>
            </li>
            <li>
              <Link href="/pricing" className="hover:underline text-gray-600 dark:text-gray-300">
                Pricing
              </Link>
            </li>
          </ul>
          <ul className="text-sm items-center space-y-2">
            <li className="font-medium text-xs text-muted-foreground">Resources</li>
            <li>
              <Link href="/p" className="hover:underline text-gray-600 dark:text-gray-300">
                Prompt Directory
              </Link>
            </li>
            <li>
              <Link href="/docs" className="hover:underline text-gray-600 dark:text-gray-300">
                Docs
              </Link>
            </li>
          </ul>
          <ul className="text-sm items-center space-y-2">
            ...
            <li>
              <Link href="/dmca" className="hover:underline text-gray-600 dark:text-gray-300">
                DMCA
              </Link>
            </li>
          </ul>
