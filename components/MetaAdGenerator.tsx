...
export default function MetaAdGenerator() {
  ...
  return (
    <div className="mx-auto max-w-md rounded-2xl border border-emerald-200/50 bg-white p-5 shadow-sm ring-1 ring-emerald-500/10 dark:border-emerald-900/40 dark:bg-gray-900">
