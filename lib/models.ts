...
export const supportedModels: Model[] = [
  // OpenAI
  {
    ...
    type: 'Proprietary',
    category: 'LLM',
    description: "OpenAI's latest reasoning model with breakthrough performance on complex tasks.",
    capabilities: ['Advanced Reasoning', 'Problem Solving', 'Chain-of-Thought'],
    icon: '',
    color: 'bg-emerald-100 dark:bg-emerald-900',
    textColor: 'text-emerald-600 dark:text-emerald-400',
    features: ['State-of-the-art reasoning', 'Complex problem solving', 'Extended thinking time'],
    useCases: ['Research', 'Mathematics', 'Complex analysis'],
  ...
  },
  {
    ...
    type: 'Proprietary',
    category: 'LLM',
    description: 'Reasoning-focused model that thinks before answering for better accuracy.',
    ...
    useCases: ['Scientific research', 'Code debugging', 'Strategic planning'],
    companyUrl: 'https://openai.com',
  },
  {
    id: 'gpt-5',
  ...
  },
  {
    ...
    type: 'Proprietary',
    category: 'LLM',
    description: 'Latest Sonnet with enhanced reasoning, coding, and multimodal capabilities.',
    capabilities: ['Enhanced Reasoning', 'Coding', 'Multimodal'],
    icon: '',
    color: 'bg-pink-100 dark:bg-pink-900',
    textColor: 'text-pink-600 dark:text-pink-400',
    features: ['Improved coding', 'Better reasoning', 'Vision capabilities'],
    useCases: ['Software development', 'Data analysis', 'Content creation'],
    companyUrl: 'https://www.anthropic.com/claude',
  },
  {
    id: 'claude-4-sonnet',
  ...
  // Google
  {
    ...
    type: 'Proprietary',
    category: 'LLM',
    description: 'Latest Gemini with breakthrough multimodal capabilities and advanced reasoning.',
    capabilities: ['Advanced Multimodal', 'Enhanced Reasoning', 'Massive Context'],
    icon: '',
    color: 'bg-blue-100 dark:bg-blue-900',
    textColor: 'text-blue-600 dark:text-blue-400',
    features: ['Next-gen multimodal', '2M+ token context', 'Superior reasoning'],
    useCases: ['Complex analysis', 'Multimodal tasks', 'Enterprise applications'],
