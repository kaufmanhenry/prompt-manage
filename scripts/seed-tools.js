...
const keyType = (process.env.SUPABASE_SERVICE_ROLE || process.env.SUPABASE_SERVICE_ROLE_KEY) ? 'SERVICE_ROLE' : 'ANON (Likely cause of RLS error)';
        ...
        const tools = [
            {
                ...
                description: 'AI design tool for creating stunning visuals and user interfaces. Streamline your design workflow with intelligent automation.',
            ...
            },
            {
                ...
                description: 'AI image generation with stunning artistic quality and creative control over style and composition.',
            ...
            },
            {
                ...
                description: 'AI music generation platform that creates original songs, melodies, and audio content.',
            ...
            },
            {
                ...
                description: 'AI video generation and editing platform with advanced visual effects and creative tools.',
            ...
            },
            {
                ...
                description: 'Advanced AI language model for conversation, writing, analysis, and coding assistance.',
