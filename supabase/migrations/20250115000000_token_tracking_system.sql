...
-- Migration: 20250115000000_token_tracking_system.sql
...
-- Uncomment if you want to initialize budgets for all users
/*
INSERT INTO public.usage_budgets (entity_type, entity_id, monthly_budget_usd)
SELECT 'user', id, 50.00
FROM auth.users
